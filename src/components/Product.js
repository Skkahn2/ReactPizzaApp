...
// }
  ...
  return (
    ...
    <div className="w-52 my-8 border-2 rounded-lg shadow-md">
       </div>
       <div >
       <img src={product.image} alt="pizza" />
        <div className="text-center">
           <h2 className="text-lg font-bold py-2">{product.name}</h2>
           <span className="bg-gray-200 py-2 rounded-full text-sm px-6">{ product.size }</span>
        </div> 

       <div className="flex justify-evenly py-2 px-2 items-center mt-4">
